...
import { Layout, Form, FormLayout, TextField, Card, Page, Frame } from "@shopify/polaris";
...
export default function NewCustomizationPage() {
    ...
    const handleSubmit = async () => {
        ...
        if (response.status != 200) {
            ...
            console.log("Error creating payment customization: ", errorResponse.error);
        } else {
            redirect();
        }
        setIsLoading(false);
    };
// [START payment_customization-move-payment-method.create-form-ui]
    // A basic input form page created using Polaris components
    return (
        <Frame>
            <Page
                title="Move payment method"
                primaryAction={{
            ...
            >
                <Layout.Section>
                    <Card title="Create Payment Customization">
                        <Card.Section>
                            <p>Enter the payment method to move when the cart is below the total</p>
                        </Card.Section>
                        <Card.Section>
                                ...
                                <FormLayout>
                                    <FormLayout.Group>
                                        ...
                                        <TextField
                                            ...
                                            onChange={(value) => handleInputChange(value, "cartTotal")}
                                            disabled={isLoading}
                                            requiredIndicator
                                        />
                                    </FormLayout.Group>
   ...
   // [END payment_customization-move-payment-method.create-form-ui]
}
